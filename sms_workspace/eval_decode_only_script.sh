...
do
    ...
    do
        ...
        # # Python 스크립트 실행
        python sms_workspace/benchmark_offloaded_decode_only.py \
            --model_name "$model" \
            --max_length "$ctx_length" \
            --output_dir "sms_outputs/paper_efficiency/${model_name}/decode_only_${cache_type}__gen${ctx_length}_48cpu_core" \
            --seed 42 \
