...
do
    ...
    do
        ...
        # Python 스크립트 실행
        python sms_workspace/benchmark_base_clustering_e2e.py \
            --model_name "$model" \
            --prefill_length "$prefill_length" \
            --gen_length "$gen_length" \
            --output_dir "sms_outputs/paper_efficiency/${model_name}/${cache_type}__pre${prefill_length}__gen${gen_length}_base_clustering_cm_agpu" \
            --seed 42 \
