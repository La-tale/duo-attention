...
do
    ...
    do
        ...
        # Python 스크립트 실행
        python sms_workspace/benchmark_proposed_clustering_e2e_wo_overhead.py \
            --model_name "$model" \
            --prefill_length "$prefill_length" \
            --gen_length "$gen_length" \
            --output_dir "sms_outputs/paper_efficiency/${model_name}/motiv_${cache_type}__pre${prefill_length}__gen${gen_length}_proposed_clustering_wo_overhead" \
            --seed 42 \
