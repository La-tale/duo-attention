...
if __name__ == "__main__":
    ...
    #  if args.model_name == "gradientai/Llama-3-8B-Instruct-Gradient-1048k":
    #      num_hidden_layers = 3
    #      model.model.layers = model.model.layers[:num_hidden_layers] ## For memory running in two GPU
    #      model.config.num_hidden_layers = num_hidden_layers ## For balanced partitioning
    model.eval()
    ...
    model = to_device(model, devices, enable_pp=pp)
